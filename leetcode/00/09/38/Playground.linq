...
[Test]
[TestCase(new object[] { 10, 5, 15, 3, 7, null, 18 }, 7, 15, 32)]
[TestCase(new object[] { 10, 5, 15, 3, 7, 13, 18, 1, null, 6 }, 6, 10, 23)]
public void SolutionTests(object[] data, int low, int high, int expected)
{
    var root = CreateTree(data);
    var actual = new Solution().RangeSumBST(root, low, high);
